...
import com.socrata.bq.store.index.SoQLIndexableRep.IndexableSqlColumnRep
...
import com.socrata.bq.store.index.{Indexable, FullTextSearch, IndexSupport, SoQLIndexableRep}
